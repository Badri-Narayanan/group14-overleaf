...
\begin{figure}[ht]
    \centering
    \includegraphics[height=5cm]{png/loadBalancerAndVirtualHost/LB-1.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[height=5cm]{png/loadBalancerAndVirtualHost/LB-2.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[height=5cm]{png/loadBalancerAndVirtualHost/VH-1.png}
