...
\begin{figure}[ht]
    \centering
    \includegraphics[height=8cm,width=8cm]{png/loadBalancerAndVirtualHost/LB-1.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[height=8cm,width=8cm]{png/loadBalancerAndVirtualHost/LB-2.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[height=8cm,width=8cm]{png/loadBalancerAndVirtualHost/VH-1.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[height=8cm,width=8cm]{png/loadBalancerAndVirtualHost/VH-2.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[height=8cm,width=8cm]{png/loadBalancerAndVirtualHost/droplet.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[height=8cm,width=8cm]{png/loadBalancerAndVirtualHost/droplet-2.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[height=8cm,width=8cm]{png/loadBalancerAndVirtualHost/docker.png}
